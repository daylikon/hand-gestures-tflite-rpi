...
training_set = train_datagen.flow_from_directory(
        'C:/Users/andre/Desktop/t/data/data/train',
...
test_set = test_datagen.flow_from_directory(
        'C:/Users/andre/Desktop/t/data/data/test',
        target_size=(64,64),#it should same as the input shape in convolaion
        batch_size=32,
        color_mode='grayscale',
        class_mode='categorical')
...
classifier.save('C:/Users/andre/Desktop/t/hand_gestures_1.h5') #name of the model
